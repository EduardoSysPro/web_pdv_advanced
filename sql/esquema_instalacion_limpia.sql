-- =============================================================
-- ESQUEMA DE INSTALACIÓN LIMPIA (sin productos)
-- Base de datos: web_pdv_advanced_db
-- Sistema: PDV (Punto de Venta) de Abarrotes
-- Este script crea unicamente la estructura de la base de datos
-- mas los datos base del sistema (cajas, configuracion y usuarios).
-- NO incluye categorias, productos ni clientes de prueba.
-- =============================================================
...
-- =============================================================
-- TABLA: cajas
-- Cajas del negocio (Caja 01, Caja 02, ...)
-- =============================================================
CREATE TABLE cajas (
...
CREATE TABLE ventas (
    ...
    metodo_pago     ENUM('efectivo', 'tarjeta', 'transferencia', 'credito', 'mixto') NOT NULL DEFAULT 'efectivo' COMMENT 'Método de pago utilizado (mixto = combinación de varios métodos)',
    pagos           TEXT NULL COMMENT 'Desglose de pagos en formato JSON: [{"metodo": "...", "monto": 0.00}]',
...
-- NOTA: No se insertan categorías, productos ni clientes de prueba.
-- =============================================================
